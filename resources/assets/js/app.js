...
window.App = function () {
    ...
    var uiLayout = function () {
        ...
        jQuery('a[data-redirect]').on('click', function (e) {
            e.preventDefault();
            var href = $(this).data('href') ? $(this).data('href') : $(this).attr('href');
            route().redirect(href, $(this).data('redirect'));
        });
    };
    ...
    var uiBlocks = function () {
        ...
        jQuery('body').on('click', '[data-toggle="block-option"]', function () {
...
// Canvas Menu functions here Left
$(document).ready(function () {
    var menu = "close";
    $(".toggle_Left").click(function () {
        if (menu == "close") {
            $(".canvasMenuLeft").css('transform', 'translate(0, 0)');
            $(".warrper").css('transform', 'translate(288px, 0)');
            $(".warrper").css('padding', '0');
            menu = "open";

        } else {
            $(".canvasMenuLeft").removeAttr('style');
            $(".warrper").removeAttr('style');
            menu = "close";
        }
    });
});
...
$(document).ready(function () {
    ...
    $(".toggle_Right").click(function () {
        if (menu == "close") {
            ...
            $(".warrper").css('transform', 'translate(-70%, 0)');
            $(".warrper").css('padding', '0');
            menu = "open";
        } else {
            $(".canvasMenuRight").removeAttr('style');
            $(".warrper").removeAttr('style');
            menu = "close";
        }
    });
...
$(document).ready(function () {
    $(".fontSize").click(function () {
        ...
        if ($(".fontSize").hasClass("fa-caret-down")) {
            $(".fontSize").removeClass("fa-caret-down");
            $(".fontSize").addClass("fa-caret-up");
        }
        else {
            $(".fontSize").addClass("fa-caret-down");
            $(".fontSize").removeClass("fa-caret-up");
        }

        $(".clickToggle .first_clickToggle").slideToggle();
    });
});
...
$(document).ready(function () {
    $(document).on("click", ".local_class_clickable", function (e) {
        ...
        $(this).siblings(".local_class_show").slideToggle();
    });
