<div class="bg-img overflow-hidden push" style="background-image: url('{{asset('/images/headers/' . $backgroundImage . '.jpg')}}');">
    <div class="{{ isset($backgroundClass) ? $backgroundClass :  null }}">
        <div class="content">
