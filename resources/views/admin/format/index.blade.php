...
@section('content')
    <div id="admin-format-list">
        <div class="row m-b-md">
            <div class="col-md-12 text-right">
                <button class="btn btn-info" v-on:click="showCreate">Create new Format</button>
            </div>
        </div>
        ...
        <div id="format-modal" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" v-text="(forms.modal.id) ? 'Edit '+forms.modal.name+' Format' : 'Create new Format'"></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div v-bind:class="errors.modal.enabled ? 'form-group has-error' : 'form-group'">
                            <label>
                                ...
                                Enabled <small>(This option is responsible for displaying the format on the site)</small>
                            </label>
