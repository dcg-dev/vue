            ...
            <div class="project-list table-responsive">
                <table class="table table-hover" v-if="!collection.isEmpty()">
                    ...
                    <tr v-for="item in collection.getData()">
                        ...
                        <td>
                            <a v-bind:href="item.get('sender').getEditUrl()"
                               v-text="item.get('sender').get('username')"></a>
                        </td>
                        <td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div v-bind:class="errors.modal.message ? 'form-group has-error' : 'form-group'">
                            <label>Comment</label>
                            <textarea class="form-control" v-model="modal.attributes.message"></textarea>
                            <span class="help-block" v-if="errors.modal.message">
                            <div v-for="error in errors.modal.message">
